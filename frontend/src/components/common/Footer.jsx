    ...
    <footer className={`py-5 border-t border-gray-100 dark:border-white/10 ${className}`}>
      <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-400 dark:text-white/40">
        ...
        <div className="flex items-center gap-4">
          <a href="/terms"   className="hover:text-gray-600 dark:hover:text-white/70 transition-colors inline-flex items-center min-h-[44px] px-1">이용약관</a>
          <a href="/privacy" className="hover:text-gray-600 dark:hover:text-white/70 transition-colors inline-flex items-center min-h-[44px] px-1">개인정보처리방침</a>
