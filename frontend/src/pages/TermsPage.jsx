  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <p className="text-sm text-gray-400 dark:text-white/40 mb-10">최종 업데이트: 2026년 4월 4일</p>
